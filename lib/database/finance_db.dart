...
import 'package:wallet_ease/database/database_service.dart';
import 'package:wallet_ease/models/category_model/categories.dart';
...
class FinanceDB {
  ...
  Future<int> deleteExpense({
    ...
    return await database
        .rawDelete('DELETE FROM $expenseTable WHERE id = ?', [id]);
  }
  ...
  Future<int> deleteAllowance({
    ...
    return await database
        .rawDelete('DELETE FROM $allowanceTable WHERE id = ?', [id]);
  }
