...
class RecentDataList extends StatefulWidget {
  ...
  const RecentDataList(
      {super.key, required this.searchQuery, required this.selectedMonth});
            ...
            onLongPress: () => showDialog(
                ...
                builder: (BuildContext dialogContext) {
                  return DeleteItem(
                      ...
                      delete: () =>
                          _deleteAllowanceItem(context, item.amount, item.id),
            ...
            onLongPress: () => showDialog(
                ...
                builder: (BuildContext dialogContext) {
                  return DeleteItem(
                      item: item.name,
                      delete: () =>
                          _deleteExpenseItem(context, item.expense, item.id),
                      context: dialogContext);
                }),
            child: ListTile(
